...
//       const botReply = data?.botReply || data?.data?.botReply || "Sorry, no reply.";

//       setMessages((prev) => [...prev, { botReply }]);
//     } catch (err) {
//       console.error("Error:", err);
//       setMessages((prev) => [...prev, { botReply: "Error connecting to bot." }]);
//     }
//   };
...
//         <div className="h-96 overflow-y-auto mb-4 p-3 space-y-3 bg-gray-50 rounded">
//           {messages.map((msg, index) => (
//             <div key={index} className="flex flex-col">
//               {msg.userMessage && (
//                 <div className="self-end bg-green-200 px-4 py-2 rounded-lg max-w-xs">
//                   {msg.userMessage}
//                 </div>
//               )}
//               {msg.botReply && (
